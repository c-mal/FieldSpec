...
FieldSpec is a native Android application built for real-time gamma spectroscopy utilizing the Gamma Spectacular GS-PRO-V5 via USB Audio.
...
2. Ensure your Galaxy S22 is enabled for USB Debugging.
...
1. Keep the phone in **Landscape** mode.
2. Plug in the GS-PRO-V5 via USB C OTG. Click start to begin recording.
3. Using the `Capture Shape (30s)` button inside **Diagnostics**, you can expose the detector to a constant standard source to record a new perfect template. The app averages 1000 pulses and saves the profile to storage!
4. The chart can be zoomed/panned. Tapping any bar reveals its Bin Number and Count!
